<!-- install the terraform and setup the path
install the aws cli and configure the keys profiles for the aws cli : your user home directory .aws config /credentials
profile for the aws cli : your home directory .aws
config/credentials
...
we are going to create the vpc useing with terraform
provider: aws
region : 
resource: vpc 
cidr: 10.1.0.0/16 
